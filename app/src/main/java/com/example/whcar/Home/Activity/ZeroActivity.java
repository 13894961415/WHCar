...
public class ZeroActivity extends AppCompatActivity implements BaseRefreshListener {
    ...
    private void initModel() {
        for (int i=0;i<20;i++){
            HomeVerGridModel model1 = new HomeVerGridModel(R.mipmap.shoufu,"零首付车"+i,"201"+1+"款",
    ...
    private void initView() {
        ...
        veradapter = new HomeVerGridAdapter(ZeroActivity.this,vermodels);
