...
public class HomeOneGridAdapter extends BaseAdapter {
    private Context context;
    private List<HomeHorGridModel1> models = new ArrayList<>();

    public HomeOneGridAdapter(Context context, List<HomeHorGridModel1> models) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        HomeHorGridModel1 model = models.get(position);
        ViewHolder viewHolder = null;
        if (convertView==null){
            viewHolder = new ViewHolder();
            convertView = LayoutInflater.from(context).inflate(R.layout.home_re_grid_item,null);
